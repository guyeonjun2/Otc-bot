...
# ... (나머지 로직인 update_member_rank, ApproveView, OTCView 등은 동일하게 유지) ...
...
class OTCView(View):
    ...
    async def help(self, interaction: discord.Interaction, button: Button):
        await interaction.response.send_message("도움말 내용...", ephemeral=True)
